...
fun DeleteConfirmationScreen(
    ...
    note: Note,
    onCloseRequest: () -> Unit,
    onConfirmNoteDeletion: (Note?) -> Unit
) {

    Column(modifier = modifier, horizontalAlignment = Alignment.CenterHorizontally) {
        Text("Are you sure you want to delete note ${note.title}?", Modifier.padding(8.dp))
        Text(
